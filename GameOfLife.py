...
def print_grid(rows, cols, grid, generation):
    ...
    output_str += "Generation {0} - Exit <Ctrl-C>\n\r".format(generation)
    for row in range(rows):
        for col in range(cols):
            if grid[row][col] == 0:
                output_str += "  "
...
def run_game():
    ...
    print("  ________                                   _____     _____    ___  _____       ")
    print(" /  _____/_____    _____   ____        _____/ ____\    |    |   |__|/ ____\____  ")
    print("/   \  ___\__  \  /     \_/ __ \      /  _ \   __\     |    |   |  \   __\/ __ \ ")
    print("\    \_\  \/ __ \|  Y Y  \  ___/     (  <_> )  |       |    |___|  ||  | \  ___/ ")
    print(" \________(______/__|_|__/\_____>     \____/|__|       |________\__||__|  \_____>")
    print("")
    print("github.com/TheBaasinenHauki/GameOfLife")
    print("")
    print("Version: 1.0")
    print("")
